...
@export var weapon_db = {
	...
	Enums.WeaponName.ION_DISRUPTOR: {"name": "Ion Disruptor", "rarity pct": 10, "rarity": "Epic", "res": "ion-disruptor", "colour": "ffd7ff", "base rate": 0.2, "level rate": 0.025, "damage":7, "price":2000 },

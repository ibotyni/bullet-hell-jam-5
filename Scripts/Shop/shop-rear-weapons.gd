...
func _ready():
	...
	if global.rear_weapon == Enums.WeaponName.NONE:
		...
		$ShopSlot1/Card.weapon = global.rear_weapon
		$ShopSlot1/Card.power_level = global.rear_weapon_power
...
func _on_power_up_pressed():
	...
	global.rear_weapon_power += 1
	if global.rear_weapon_power > 10:
		global.rear_weapon_power = 10
	CalcBuySellPrice()
	ShowBuySellPrice()
...
func _on_shop_slot_1_pressed():
	...
	global.rear_weapon = $ShopSlot1/Card.weapon
	global.rear_weapon_power = 1
	CalcBuySellPrice()
	Protoship.player_wallet -= curr_price
	ShowBuySellPrice()
...
func _on_shop_slot_2_pressed():
	...
	global.rear_weapon = $ShopSlot2/Card.weapon
	global.rear_weapon_power = 1
	CalcBuySellPrice()
	Protoship.player_wallet -= curr_price
	ShowBuySellPrice()
...
func _on_shop_slot_3_pressed():
	...
	global.rear_weapon = $ShopSlot3/Card.weapon
	global.rear_weapon_power = 1
	CalcBuySellPrice()
	Protoship.player_wallet -= curr_price
	ShowBuySellPrice()
...
func _on_shop_slot_4_pressed():
	...
	global.rear_weapon = $ShopSlot4/Card.weapon
	global.rear_weapon_power = 1
	CalcBuySellPrice()
	Protoship.player_wallet -= curr_price
	ShowBuySellPrice()
...
func _on_shop_slot_none_pressed():
	Protoship.player_wallet += TotalPrice()
	$Selection.position.y = 257
	global.rear_weapon = Enums.WeaponName.NONE
	global.rear_weapon_power = 1
	CalcBuySellPrice()
	ShowBuySellPrice()
...
func CalcBuySellPrice():
	prev_price = CalcPrice(global.rear_weapon, global.rear_weapon_power - 1)
	curr_price = CalcPrice(global.rear_weapon, global.rear_weapon_power)
	next_price = CalcPrice(global.rear_weapon, global.rear_weapon_power + 1)
...
func ShowBuySellPrice():
	...
	if global.rear_weapon == Enums.WeaponName.NONE:
		...
		$PowerLevel.text = "Power: %d" % global.rear_weapon_power
		$SellPrice.text = str( prev_price )
		$BuyPrice.text = str( next_price )
		$"Power-Down".visible = global.rear_weapon_power != 1
		$"Power-Up".visible = global.rear_weapon_power != 10
...
func TotalPrice():
	...
	var total = 0
	for i in range(1, global.rear_weapon_power + 1):
		total += CalcPrice(global.rear_weapon, i)
	return total
